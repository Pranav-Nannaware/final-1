<?php
// This file contains the error page content to be included after failed registration
// It expects $errorMessage to be set
?>
...
<head>
    ...
    <title>Registration Error - Student Registration</title>
...
<body>
                        ...
                        <div class="campus-section">
                            <div class="error-message">
                                ...
                                <div class="error-details">
                                    ...
                                    <p><?php echo htmlspecialchars($errorMessage ?? 'An unknown error occurred.'); ?></p>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Add subtle animation to error elements
            const errorCard = document.querySelector('.error-message');
            if (errorCard) {
                errorCard.style.opacity = '0';
                errorCard.style.transform = 'translateY(20px)';
                
                setTimeout(() => {
                    errorCard.style.transition = 'all 0.6s ease-out';
