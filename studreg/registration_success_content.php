<?php
// This file contains the success page content to be included after successful registration
// It expects $successStudentId to be set
...
<head>
    ...
    <title>Registration Successful - Student Registration</title>
                    ...
                    <div class="campus-card">
                        <div class="campus-section">
                            <div class="success-message">
                                ...
                                <p class="mb-4">Thank you for registering with our institution. Your information has been successfully submitted and stored in our system.</p>
                                ...
                                <div class="student-info">
                                    ...
                                    <div class="info-grid">
                                        <div class="info-item">
                                            <p><strong>Registration ID:</strong> <?php echo $successStudentId; ?></p>
                                        </div>
                                        <div class="info-item">
                                    ...
                                    <div class="alert alert-info mt-3">
                                        ...
                                        <strong>Important:</strong> Please keep your Registration ID (<strong><?php echo $successStudentId; ?></strong>) for future reference. You will need this for any follow-up communications.
                                    </div>
                                </div>
                                <?php else: ?>
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="mt-4 d-flex justify-content-center gap-3 flex-wrap">
                                        ...
                                        <a href="index.php" class="campus-btn">
