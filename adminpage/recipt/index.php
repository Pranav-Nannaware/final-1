...
if ($_POST) {
    ...
    if (isset($_POST['search_student']) && !empty($_POST['search_query'])) {
        ...
        $is_id_search = ctype_digit($search_query);
        if ($is_id_search) {
            // If searching by ID, require exact match and numeric only
...
<head>
    ...
    <script>
        ...
        function validateSearchInput(input) {
            // If the input looks like a number, only allow digits
...
<body>
    <div class="nav-header">
        <h1><i class="fas fa-receipt"></i> New Payment Receipt Generator</h1>
        <div class="nav-links">
