...
if (isset($_POST['aidedRegNo'])) {
    ...
    if ($student) {
        ...
        echo "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width, initial-scale=1.0'><title>Student Details - Aided</title><link rel='stylesheet' href='assets/modern-theme.css'></head><body>";
        ?>
        <div class="container">
            <div class="card fade-in">
                ...
                <div class="text-center mt-8">
                    <a href="fees_aided.php" class="btn btn-primary btn-lg">
